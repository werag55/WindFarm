...
RAW_DATASET_PATH = "WindFarm/data/data1.csv"
CLEANED_DATA_PATH = "WindFarm/data/cleaned_offshore_wind_data.csv"
CALCULATED_DATA_PATH = "WindFarm/data/calculated_offshore_wind_data.csv"
MAP_HTML_PATH = "WindFarm/results/offshore_wind_profitability_map.html"
MODEL_REPORT_PATH = "WindFarm/results/profitability_model_report.json"
MODEL_DASHBOARD_PATH = "WindFarm/results/profitability_model_dashboard.html"
